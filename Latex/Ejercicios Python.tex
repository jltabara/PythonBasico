...
\ChTitleVar{\huge\sffamily\bfseries\color{burgundy}}
\ChNumVar{\color{burgundy}\fontsize{76}{80}\usefont{OT1}{pzc}{m}{n}\selectfont}



\usepackage[a4paper, total={\textwidth,9.5in }]{geometry}



\newenvironment{capitulo}{\begin{tcolorbox}[colback=blue!5!white,colframe=blue!50!black]}{\end{tcolorbox}}
\newenvironment{ejer}{\begin{tcolorbox}[colback=blue!2!white,colframe=blue!50!black]}{\end{tcolorbox}}

\newenvironment{code}{\begin{tcolorbox}[colback=red!2!white,colframe=blue!50!black]}{\end{tcolorbox}}
...
\subsubsection*{Comillas dobles y simples}
...
\subsubsection*{Dos líneas con dos sentencias}
...
\subsubsection*{Dos líneas con una única sentencia}
...
\subsubsection*{Comillas dentro del texto}
...
\subsubsection*{\dag{} Repetición de la misma cadena}
...
\subsubsection*{Multiplicaciones}
...
\subsubsection*{Colocación de paréntesis}
...
\subsubsection*{Prioridad de las potencias}
...
\subsubsection*{Cociente y resto}
...
\subsubsection*{Espacios en blanco entre operadores}
...
\subsubsection*{\dag{}  Prioridad de operaciones con //}
...
\subsubsection*{\dag{} División entre cero}
...
\subsubsection*{\dag{}  La función \textit{divmod()}}
...
\subsubsection*{\dag{} La función \textit{pow()}}
...
\subsubsection*{\dag{}  Convertir números a binario}
...
\subsubsection*{\dag{} Convertir de binario a entero}
...
\subsubsection*{Convertir pies en metros}
...
\subsubsection*{Muchos decimales es imposible}
...
\subsubsection*{La fórmula de Einstein}
...
\subsubsection*{\dag{} La función \textit{round()} }
...
\subsubsection*{Guardar valores en variables}
...
\subsubsection*{Perímetro de una circunferencia}
...
\subsubsection*{Reasignación de valores a variables}
...
\subsubsection*{Nombres permitidos para variables}
...
\begin{ejer}
 ...
 \subsubsection*{\dag{} Las letras acentuadas en las variables}
 ...
 \subsubsection*{\dag{} Borrado de variables con `del`}

Una vez creada una variable sigue existiendo en memoria hasta la terminación del programa. Si queremos borrar una variable utilizamos la orden \verb|del|. Prueba el siguiente código que crea una variable, la imprime y después la borra. Comprueba que la variable ya no existe.
...
\subsubsection*{ \dag{} Operaciones en la parte derecha de una asignación}
...
\subsection*{$[\Uparrow]$ Inicializar varias variables al mismo tiempo}
...
\subsubsection*{\dag{} Operadores en asignación}
...
\subsection*{\dag{} Controlar los decimales}
...
\subsubsection*{La suma de dos variables}
...
\subsubsection*{El doble y el triple}
...
\subsubsection*{Área de un rectángulo} 
...
\subsubsection*{Área y perímetro de un círculo}
...
\chapter{Programas II}


\begin{ejer}


\subsubsection*{De kilómetros a metros}
...
\subsubsection*{De pulgadas a centímetros}
...
\subsubsection*{De grados centígrados a Farenheit} 
...
\subsubsection*{Guardar cadenas en variables}
...
\subsubsection*{\dag{} Poner en mayúsculas y minúscula una cadena}
...
\subsubsection*{\dag{}  Escribir carácteres que no aparecen en el teclado}
...
\subsubsection*{Acceder a distintos caracteres de una cadena}
...
\subsubsection*{Slicing con cadenas}
...
\subsubsection*{\dag{} Dar la vuelta a una cadena}
...
\chapter{Operadores relacionales}


\subsubsection*{Operadores relacionales y variables}
...
\subsubsection*{Guardar resultados de comparaciones en variables}
...
\subsubsection*{Un resultado inesperado}
...
\subsubsection*{El orden alfabético}
...
\subsubsection*{\dag{} El número asociado a cada letra o caracter}
...
\subsubsection*{\dag{}  El caracter asociado a un número}
...
\subsubsection*{ \dag{} El orden en las letras}
...
\subsubsection*{\dag{} Comparación de cadenas}
...
\subsection*{Guardar y comprobar el tipo}
...
\subsection*{El tipo de una división}
...
\subsection*{El tipo del cociente de enteros}
...
\subsection*{El tipo de \textit{True} y \textit{ False}}
...
\subsection*{El tipo de las comparaciones}
...
\subsection*{Python es un lenguaje de tipado dinámico}
...
\subsection*{\dag{} El tipo complejo}
...
\chapter{Entrada por teclado}



\begin{ejer}

\subsubsection*{ Pedir el nombre y la edad}
...
\subsubsection*{Pedir dos números y realizar cuatro operaciones}
...
\subsubsection*{Área  y perímetro de un rectángulo}
...
\subsubsection*{Usar variables dentro de la función \textit{input()}}
...
\subsection*{Fallo de indentación}
...
\subsection*{Cambiar dos \textit{if} por un  \textit{else...if}}
...
\subsection*{Detectar error semántico}
...
\chapter{Operadores lógicos}


\begin{ejer}

\subsection*{Tabla de verdad del operador \textit{and}}
...
\subsection*{Traducir al lenguaje Python}
...
\subsection*{Operación combinada}
...
\subsection*{\dag{}  Otra forma de realizar los operadores booleanos}
...
\subsection*{\dag{} Un atajo para los condicionales}
...
\subsection*{Acceder a elementos de una lista}
...
\subsection*{\dag{}$[\Uparrow]$ Los índices tienen que ser enteros}
...
\subsection*{Crear listas con el mismo elemento}
...
\subsection*{Multiplicación y concatenado}
...
\subsection*{\dag{} Convertir cadenas en listas}
...
\subsection*{Elementos en listas}
...
\subsection*{\dag{} Listas anidadas}
...
\subsection*{\dag{} Más listas anidadas}
